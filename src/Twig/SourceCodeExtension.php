...
class SourceCodeExtension extends AbstractExtension
{
    ...
    public function showTemplateCode(Environment $twig, $template, $pre_block = true): string
    {
    ...
    public function showSourceCode(Environment $twig, $code, $pre_block = true): string
    {
        return $twig->render('debug/source_code.html.twig', [
            'controller' => $this->getController(),
            'template'   => ['source_code' => $code],
            'pre_block'  => $pre_block,
        ]);
    }
